    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-gray-900/50 border border-gray-800 rounded-3xl p-8 shadow-2xl backdrop-blur-xl relative overflow-hidden group">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-black text-white mb-2 tracking-tight">Join VibeChat</h1>
          <p className="text-gray-400 text-sm font-medium">Create an account to start vibing with others.</p>
        </div>
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="relative group">
              <User className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 group-focus-within:text-iris-500 transition-colors" size={18} />
              <input
                type="text"
